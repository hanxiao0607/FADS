...
def arg_parser():
    ...
    parser.add_argument('--random_seed', help='random seed', default=6)
    parser.add_argument('--dataset_dir', help='please choose dataset directory', default='./Datasets/CERT52_small.csv')
    ...
    parser.add_argument('--max_epoch', help='max epoch for prototypical networks', default=20)
    parser.add_argument('--epoch_size', help='epoch size for each epoch of protonet', default=2000)

    # set RAD parameters
    parser.add_argument('--max_episode', help='max episode for each iterators', default=50)
    parser.add_argument('--max_iterators', help='max iterators for training RAD model', default=20)
