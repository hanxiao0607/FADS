...
def arg_parser():
    ...
    parser.add_argument('--validation_size', help='set validation size for each class', default=6)
    ...
    parser.add_argument('--n_support', help='n support', default=2)
    parser.add_argument('--n_query', help='n query', default=2)
