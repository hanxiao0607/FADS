...
def arg_parser():
    ...
    parser.add_argument('--random_seed', help='random seed', default=3)
    ...
    parser.add_argument('--validation_size', help='set validation size for each class', default=15)
    ...
    parser.add_argument('--n_support', help='n support', default=4)
    parser.add_argument('--n_query', help='n query', default=4)
