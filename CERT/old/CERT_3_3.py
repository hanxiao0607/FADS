...
def arg_parser():
    ...
    parser.add_argument('--validation_size', help='set validation size for each class', default=3)
    ...
    parser.add_argument('--n_support', help='n support', default=1)
    parser.add_argument('--n_query', help='n query', default=1)
