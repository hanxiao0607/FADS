...
from UNSW.others.early_stop import *
...
class LSTM_AE(nn.Module):
    def __init__(self, seq_len, no_features, embedding_dim, learning_rate, every_epoch_print, epochs, patience,
                 max_grad_norm):
        super().__init__()
    ...
    def fit(self, x):
        ...
        self.load_state_dict(torch.load('./saved_models/ae_checkpoint.pt'))
