...
def arg_parser():
    ...
    parser.add_argument('--ratio_ab', help='ratio of abnormal', default=0.075)
...
def main():
    ...
    # splitting dataset
    seen_x, seen_y, sup_x, sup_y, unseen_x, unseen_y, test_x, test_y = utils.preprocessing_UNSW(options, ratio_ab=options['ratio_ab'])
